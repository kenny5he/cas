package com.microfoolish.it.login.cas.account.entity;
...
/**
 * This is {@link RegistraionSuggestionEntity} that represents the audit table.
...
@Getter
@Setter
public class RegistraionSuggestionEntity {
    ...
    public RegistraionSuggestionEntity() {
