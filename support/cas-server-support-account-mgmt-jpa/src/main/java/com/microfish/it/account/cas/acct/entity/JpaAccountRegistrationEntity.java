...
public class JpaAccountRegistrationEntity implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "cas_accont_id_s")
    @SequenceGenerator(name = "cas_accont_id_s", allocationSize = 100)
    private Long id;
    ...
    @Column(name = "email_reverse", length = 50)
