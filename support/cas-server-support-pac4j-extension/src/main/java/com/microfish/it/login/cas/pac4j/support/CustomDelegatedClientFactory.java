...
import com.microfoolish.it.login.cas.pac4j.CustomPac4jAuthenticationProperties;
...
@Slf4j
public class CustomDelegatedClientFactory extends DefaultDelegatedClientFactory implements DisposableBean {

    private CustomPac4jAuthenticationProperties pca4j;

    private Set<IndirectClient> customClients = new LinkedHashSet<>();

    public CustomDelegatedClientFactory(CasConfigurationProperties casProperties, Collection<DelegatedClientFactoryCustomizer> customizers, CasSSLContext casSSLContext, ApplicationContext applicationContext) {
        super(casProperties, customizers, casSSLContext, applicationContext);
    }

    public CustomDelegatedClientFactory(CasConfigurationProperties casProperties, CustomPac4jAuthenticationProperties pca4j, Collection<DelegatedClientFactoryCustomizer> customizers, CasSSLContext casSSLContext, ApplicationContext applicationContext) {
        super(casProperties, customizers, casSSLContext, applicationContext);
        this.pca4j = pca4j;
    }
    @Override
