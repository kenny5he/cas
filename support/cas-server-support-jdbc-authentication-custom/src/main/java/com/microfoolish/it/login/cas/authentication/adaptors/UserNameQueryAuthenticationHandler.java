...
@Slf4j
@Monitorable
public class UserNameQueryAuthenticationHandler extends AbstractJdbcUsernamePasswordAuthenticationHandler<QueryJdbcAuthenticationProperties> {

    protected UserNameQueryAuthenticationHandler(QueryJdbcAuthenticationProperties properties, ServicesManager servicesManager, PrincipalFactory principalFactory, DataSource dataSource) {
